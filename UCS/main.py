...
root.title("Campus GPS Navigation - Uniform Cost Search")
...
title = tk.Label(
    ...
    text="Uniform Cost Search Navigation",
...
def find_route():
    ...
    distance, path = uniformcostsearch.uniform_cost_search(
        g,
        start,
        end
    )
